...
public class InboundStatusPage extends BaseContentPage {
    ...
    private String status_name = "현황";
    
    private OutLineButton bt_reload, bt_delete, bt_export;
    ...
    public InboundStatusPage(Color color) {
        ...
        tableModel = IoViewHelper.toTableModel(rawData, Config.TABLE_COLUMNS, status_name, false); // 테이블 모델
    	
    	// 6. 테이블 생성하기 (첫 레코드 수정 불가: false)
    	table = new TablePanel(tableModel, true, false);
    	add(table);
